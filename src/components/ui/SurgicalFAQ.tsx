...
export function SurgicalFAQ({ isEn }: { isEn: boolean }) {
...
] : [
  {
    ...
    "a": "No partimos de una plantilla. Cada sistema que construimos se diseña para un negocio concreto, con sus números y sus cuellos de botella exactos — y no sirve para ningún otro. Auditamos primero. Construimos después, solo lo necesario para que no tengas que volver a tocarlo en años."
  },
  {
