...
export default async function EspinLanding({ params }: { params: Promise<{ lang: Locale }> }) {
  ...
  const homeServices = [
    { 
      ...
      desc: dict.services[0].desc, 
      link: lang === "en" ? "/en/development" : "/es/desarrollo",
      align: "right",
      sysText: dict.services[0].sysText
    },
    { 
      id: "02", 
      title: dict.services[1].title, 
      desc: dict.services[1].desc, 
      link: lang === "en" ? "/en/agents" : "/es/agentes",
      align: "left",
      sysText: dict.services[1].sysText
    },
    { 
      id: "03", 
      title: dict.services[2].title, 
      desc: dict.services[2].desc, 
      link: lang === "en" ? "/en/branding" : "/es/identidad",
      align: "right",
      sysText: dict.services[2].sysText
    }
  ];
        ...
        <main>
          ...
          <section className="min-h-[100vh] leading-[1.1] md:leading-[1.1] flex flex-col justify-center px-6 md:px-12 pt-16 pb-16 md:pt-32 md:pb-24 border-b border-zinc-900 relative bg-black">
            ...
            <div className="max-w-6xl w-full md:pl-20 mt-0 relative z-10">
              <h1 className={`font-clash font-bold uppercase mb-8 md:mb-12 leading-[1.1] flex flex-col whitespace-nowrap w-full ${isEn ? "text-[9.2vw] sm:text-[8vw] md:text-6xl lg:text-[5rem] xl:text-[6rem]" : "text-[11.2vw] sm:text-[9.5vw] md:text-6xl lg:text-[5rem] xl:text-[6rem]"}`}> 
                ...
                <div className="overflow-hidden">
                  <ScrollReveal variant="textReveal" delay={0.2} className="text-white">
                    {dict.hero.titleLine3}<span className="text-[#F5B700]">.</span>
                  </ScrollReveal>
                </div>
              </h1>
              ...
              <div className="overflow-hidden mb-12 md:mb-20 pt-4">
                <ScrollReveal delay={0.3}>
                  <p className="font-inter font-light text-zinc-300 text-xl md:text-2xl lg:text-3xl max-w-4xl leading-relaxed md:leading-tight tracking-tight">
                    {dict.hero.desc1}<span className="text-[#F5B700]">{dict.hero.hl1}</span>{dict.hero.desc2}<span className="text-[#F5B700]">{dict.hero.hl2}</span>{dict.hero.desc3}
                  </p>
                </ScrollReveal>
              </div>
                ...
                <div className="mt-8 z-30 pointer-events-auto">
                  <ContactTrigger servicio="ecosistema" className="inline-block cursor-pointer">
                    <button type="button" className="rings-btn black group/btn">
                      <i></i><i></i><i></i>
                      <span>{isEn ? "Request Ecosystem" : "Solicitar Ecosistema"}</span>
                      <svg className="arr" viewBox="0 0 24 24" aria-hidden="true"><path d="M7 17L17 7M9 7h8v8"/></svg>
                    </button>
                  </ContactTrigger>
                </div>
 ...
 <h2 className="font-clash font-light text-[4vw] sm:text-lg md:text-2xl lg:text-3xl text-[#F5B700] uppercase whitespace-nowrap"> 
                        {isEn ? "PROOF OF PERFORMANCE" : "LA PRUEBA DEL RENDIMIENTO"}
                      </h2>
                    </div>
                  </ScrollReveal>
                </div>
                ...
                <ScrollReveal className="leading-[1.1] md:leading-[1.1] flex flex-col pr-0 md:pr-12 group">
                  ...
                  <div className="mb-12">
                    <span className="text-[#F5B700] text-[10px] md:text-xs font-mono tracking-widest uppercase mb-4 block">
                      {isEn ? "Traditional Sector" : "Sector Tradicional"}
                    </span>
 <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white mb-6 uppercase font-clash font-semibold group-hover:translate-x-2 transition-transform duration-500"> 
                      {isEn ? "Commercial Maritime Fleet" : "Flota Marítima Comercial"}
                    </h3>
                    <p className="font-inter font-normal text-zinc-400 text-base md:text-lg leading-relaxed">
                      {isEn ? "Complete restructuring of web architecture and creation of an unbreakable booking gateway." : "Reestructuración completa de arquitectura web y creación de pasarela de reservas inquebrantable."}
                    </p>
                  </div>
 ...
 <div className="text-6xl md:text-7xl text-white mb-2 font-clash font-semibold flex items-baseline"> 
                    ...
                    <div className="text-zinc-500 text-[10px] md:text-xs font-mono uppercase tracking-widest">
                      {isEn ? "IMMEDIATE RESPONSE" : "RESPUESTA INMEDIATA"}
                    </div>
                  </div>

                  {/* {isEn ? "Verified Impact" : "Impacto Verificado"} */}
                  <div className="mt-auto">
                    ...
                    <ul className="space-y-4 font-inter font-normal">
                      {(isEn ? ["Absolute retention of commercial leads around the clock.", "40% increase in closed bookings without human intervention.", "Elimination of bottlenecks during peak demand."] : ["Retención absoluta de leads comerciales en cualquier franja horaria.", "Aumento del 40% en cierre de reservas sin intervención humana.", "Eliminación de cuellos de botella durante picos de demanda."]).map((item, idx) => (
                ...
                <ScrollReveal className="leading-[1.1] md:leading-[1.1] flex flex-col pl-0 md:pl-12 mt-8 md:mt-0 group">
                  ...
                  <div className="mb-12">
                    <span className="text-[#F5B700] text-[10px] md:text-xs font-mono tracking-widest uppercase mb-4 block">
                      {isEn ? "B2B Services Sector" : "Sector Servicios B2B"}
                    </span>
 <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white mb-6 uppercase font-clash font-semibold group-hover:translate-x-2 transition-transform duration-500"> 
                      {isEn ? "Internal Operations" : "Operativa Interna"}
                    </h3>
                    <p className="font-inter font-normal text-zinc-400 text-base md:text-lg leading-relaxed">
                      {isEn ? "Automation of workflows and administrative tasks." : "Automatización de flujos de trabajo y tareas administrativas."}
                    </p>
                  </div>
 ...
 <div className="text-6xl md:text-7xl text-white mb-2 font-clash font-semibold flex items-baseline"> 
                    ...
                    <div className="text-zinc-500 text-[10px] md:text-xs font-mono uppercase tracking-widest">
                      {isEn ? "ADMINISTRATIVE LOAD REDUCTION" : "REDUCCIÓN DE CARGA ADMINISTRATIVA"}
                    </div>
                  </div>
                  ...
                  <div className="mt-auto">
                    ...
                    <span className="text-[#F5B700] text-[10px] md:text-xs font-mono tracking-widest uppercase mb-6 block">{isEn ? "Verified Impact" : "Impacto Verificado"}</span>
                    <ul className="space-y-4 font-inter font-normal">
                      {(isEn ? ["Your team focuses again on tasks that generate real income.", "Automatic database synchronization and instant billing.", "Reduction of mechanical errors to zero in recurring logistics flows."] : ["Tu equipo vuelve a centrarse en tareas que generan ingresos reales.", "Sincronización automática de bases de datos y facturación al instante.", "Reducción de errores mecánicos a cero en flujos logísticos recurrentes."]).map((item, idx) => (
                        <li key={idx} className="flex items-start text-zinc-400 text-sm">
                          <svg aria-hidden="true" className="w-4 h-4 text-[#F5B700] mr-4 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7"></path></svg>
                          <span>{item}</span>
                        </li>
              ...
              {[1,2,3,4,5,6].map((i) => (
                <div key={i} className="marquee-item flex items-center justify-center min-w-max">
                  <span className="font-clash font-bold text-transparent text-3xl md:text-5xl lg:text-[4.5rem] uppercase mx-4 md:mx-8" style={{ WebkitTextStroke: '1px #F5B700', color: 'transparent' }}> 
                    {isEn ? "FROMOBSOLETETOPERFORMANCE" : "DELOBSOLETOALRENDIMIENTO"}
                  </span>
          ...
          <div className="w-full flex flex-row justify-between items-center gap-6 md:gap-8">
            ...
            <div className="leading-[1.1] md:leading-[1.1] flex flex-col w-[50vw] md:w-[400px] font-mono z-10">
              ...
              <div className="leading-[1.1] md:leading-[1.1] flex flex-col border-t border-zinc-900">
                {[
                  { name: lang === 'en' ? 'Legal Notice' : 'Aviso Legal', path: `/${lang}/aviso-legal` },
                  { name: lang === 'en' ? 'Privacy Policy' : 'Privacidad', path: `/${lang}/politica-de-privacidad` },
                  { name: lang === 'en' ? 'Cookies' : 'Cookies', path: `/${lang}/politica-de-cookies` }
                ].map((item) => (
